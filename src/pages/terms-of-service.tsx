...
export default function TermsOfService() {
  return (
    <Wrapper2>
      ...
      <link rel="canonical" href="https://www.imageassist.com/terms-of-service" />
      <meta property="og:site_name" content="ImageAssist" />
      <meta property="og:title" content="Terms of Service — ImageAssist" />
      <meta property="og:url" content="https://www.imageassist.com/terms-of-service" />
      <meta property="og:type" content="website" />
      <meta itemProp="name" content="Terms of Service — ImageAssist" />
      <meta itemProp="url" content="https://www.imageassist.com/terms-of-service" />
      <meta name="twitter:title" content="Terms of Service — ImageAssist" />
      <meta name="twitter:url" content="https://www.imageassist.com/terms-of-service" />
      ...
      <div className="text-lg mb-12">
        ...
        <p>
          You can contact us by&nbsp;email at&nbsp;golinko@imageassist.com&nbsp;or by mail to&nbsp;1211 Medical Center
          Dr,&nbsp;Nashville,&nbsp;TN&nbsp;37232,&nbsp;United States.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of
          an entity ("you"), and&nbsp;Image Assist, concerning your access to and use of the Services. You agree that by
        ...
        <p>
          ...
          modifications to these Legal Terms&nbsp;from time to time. We will alert you about any changes by updating
          the&nbsp;"Last updated"&nbsp;date of these Legal Terms, and you waive any right to receive specific notice of
        ...
        <p>
          ...
          <a
            ...
            href="https://app.termly.io/builder/websites/7b460317-5d0c-4284-bb52-1159be89cd3b/documents/4324572/General/Platform%20Type#prohibited"
          >
        ...
        <ul className="list-disc pl-12 mt-4 mb-12">
          <li>
            <p>access the Services</p>
          </li>
          <li>
            <p>download or print a copy of any portion of the Content to which you have properly gained access.</p>
          </li>
        </ul>
        <p className="mb-12">solely for your&nbsp;personal, non-commercial use or internal business purpose.</p>
        <p></p>
        <p>
        ...
        <p>
          ...
          elsewhere in our Legal Terms, please address your request to:&nbsp;golinko@imageassist.com. If we ever grant
        ...
        <ul className="list-disc pl-12 mt-4 mb-12">
          <li>
            <p>
              ...
              "&nbsp;and will not post, send, publish, upload, or transmit through the Services any Submission&nbsp;nor
              post any Contribution&nbsp;that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying,
              abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate,
          ...
          <li>
            <p>
              ...
              necessary rights and&nbsp;licenses&nbsp;to submit such Submissions&nbsp;and/or Contributions&nbsp;and that
        ...
        <p>
          ...
          will not access the Services through automated or non-human means, whether through a bot, script or otherwise;
          (6) you will not use the Services for any illegal or&nbsp;unauthorized&nbsp;purpose; and (7) your use of the
        ...
        <p>
          ...
          or shipping address. We reserve the right to limit or prohibit orders that, in our sole&nbsp;judgment, appear
        ...
        <ul className="list-disc pl-12 mt-4 mb-12">
          ...
          <li>
            <p>
              ...
              formats ("gifs"), 1×1 pixels, web bugs, cookies, or other similar devices (sometimes referred to
        ...
        <p>
          ...
          Services and through third-party websites. As such, any Contributions you transmit may be treated as
        ...
        <p>
          ...
          archive, store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt (in whole or
          in part), and distribute such Contributions (including, without limitation, your image and voice) for any
          purpose, commercial, advertising, or otherwise, and to prepare derivative works of, or incorporate into other
        ...
        <p>
          ...
          service marks, trade names, logos, and personal and commercial images you provide. You waive all moral rights
          in your Contributions, and you warrant that moral rights have not otherwise been asserted in your
          Contributions.
        </p>
        <p>
          ...
          Services. You are solely responsible for your Contributions to the Services and you expressly agree to
        ...
        <p>
          ...
          application&nbsp;license&nbsp;contained in these Legal Terms. You shall not: (1) except as permitted by
          applicable law, decompile, reverse engineer, disassemble, attempt to derive the source code of, or decrypt the
          App; (2) make any modification, adaptation, improvement, enhancement, translation, or derivative work from the
        ...
        <p>
          ...
          limited to a non-transferable&nbsp;license&nbsp;to use the application on a device that&nbsp;utilizes&nbsp;the
          Apple iOS or Android operating systems, as applicable, and in accordance with the usage rules set forth in the
          ...
          applicable warranty, you may notify the applicable App Distributor, and the App Distributor, in accordance
          with its terms and policies, may refund the purchase price, if any, paid for the App, and to the maximum
          extent permitted by applicable law, the App Distributor will have no other warranty obligation whatsoever with
          respect to the App; (4) you represent and warrant that (i) you are not located in a country that is subject to
          a US government embargo, or that has been designated by the US government as a&nbsp;"terrorist
          supporting"&nbsp;country and (ii) you are not listed on any US government list of prohibited or restricted
          parties; (5) you must comply with applicable third-party terms of agreement when using the App, e.g.,&nbsp;if
          you have a VoIP application, then you must not be in violation of their wireless data service agreement when
          using the App; and (6) you acknowledge and agree that the App Distributors are third-party beneficiaries of
          the terms and conditions in this mobile application&nbsp;license&nbsp;contained in these Legal Terms, and that
          each App Distributor will have the right (and will be deemed to have accepted the right) to enforce the terms
        ...
        <p>
          ...
          your&nbsp;Third-Party&nbsp;Account, without breach by you of any of the terms and conditions that govern your
          use of the applicable&nbsp;Third-Party&nbsp;Account, and without obligating us to pay any fees or making us
          ...
          that (1) we may access, make available, and store (if applicable) any content that you have provided to and
          stored in your&nbsp;Third-Party&nbsp;Account (the&nbsp;"Social Network Content") so that it is available on
          and through the Services via your account, including without limitation any friend lists and (2) we may submit
          to and receive from your&nbsp;Third-Party&nbsp;Account additional information to the extent you are notified
          when you link your account with the&nbsp;Third-Party&nbsp;Account. Depending on
          ...
          your&nbsp;Third-Party&nbsp;Accounts may be available on and through your account on the Services. Please note
          that if a&nbsp;Third-Party&nbsp;Account or associated service becomes unavailable or our access to
          ...
          connection between your account on the Services and your&nbsp;Third-Party&nbsp;Accounts at any time. PLEASE
          NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS
          IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review
          any Social Network Content for any purpose, including but not limited to, for accuracy, legality, or
          non-infringement, and we are not responsible for any Social Network Content. You acknowledge and agree that we
          ...
          and your&nbsp;Third-Party&nbsp;Account by contacting us using the contact information below or through your
        ...
        <p>
          ...
          hosted in&nbsp;the&nbsp;United States. If you access the Services from any other region of the world with laws
          ...
          data to&nbsp;the&nbsp;United States, and you expressly consent to have your data transferred to and processed
        ...
        <p>
          ...
          PARTICIPATION IN THE SERVICES OR DELETE&nbsp;YOUR ACCOUNT AND&nbsp;ANY CONTENT OR INFORMATION THAT YOU POSTED
        ...
        <p>
          ...
          Services.&nbsp;We will not be liable to you or any third party for any modification, price change, suspension,
        ...
        <p>
          ...
          <a href="http://www.adr.org/">American Arbitration Association (AAA) website</a>. Your arbitration fees and
          ...
          in&nbsp;Davidson,&nbsp;Tennessee. Except as otherwise provided herein, the Parties may litigate in court to
        ...
        <p>
          ...
          prosecuted in the&nbsp;&nbsp;state and federal courts&nbsp;located in&nbsp;Davidson,&nbsp;Tennessee, and the
        ...
        <p>
          ...
          OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY
        ...
        <p>
          ...
          CAUSE OF ACTION ARISING.&nbsp;CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED
        ...
        <p>
          ...
          of:&nbsp;(1) your Contributions;&nbsp;(2) use of the Services; (3) breach of these Legal Terms; (4) any breach
          of your representations and warranties set forth in these Legal Terms; (5) your violation of the rights of a
          ...
          which you are required to indemnify us, and you agree to cooperate, at your expense, with
        ...
        <p>
          In the event of security or data breach of the user or any of the users entered subject or patient data,
        ...
        <p>
          ...
          all&nbsp;defenses&nbsp;you may have based on the electronic form of these Legal Terms and the lack of signing
        ...
        <p>Image Assist</p>
        <p>1211 Medical Center Dr</p>
        <p>Nashville,&nbsp;TN&nbsp;37232</p>
        <p>United States</p>
        <p>golinko@imageassist.com</p>
      </div>
    </Wrapper2>
  );
}
